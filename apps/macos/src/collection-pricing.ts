...
const endpointPaths: Record<string, string[]> = {
  ...
  'tiktok.user_search': ['/api/v1/tiktok/app/v3/fetch_user_search_result'],
  ...
  'tiktok.followers': ['/api/v1/tiktok/app/v3/fetch_user_follower_list'],
  'tiktok.followings': ['/api/v1/tiktok/app/v3/fetch_user_following_list'],
  'tiktok.similar_accounts': ['/api/v1/tiktok/app/v3/fetch_similar_user_recommendations'],
  'tiktok.account_country': ['/api/v1/tiktok/app/v3/fetch_user_country_by_username'],
  'douyin.keyword_search': ['/api/v1/douyin/search/fetch_video_search_v2'],
  'douyin.user_search': ['/api/v1/douyin/search/fetch_user_search'],
  ...
  'douyin.followers': ['/api/v1/douyin/web/fetch_user_fans_list'],
  'douyin.followings': ['/api/v1/douyin/web/fetch_user_following_list'],
  'douyin.extended_demographics': ['/api/v1/douyin/web/handler_user_profile_v4'],
  'xiaohongshu.keyword_search': ['/api/v1/xiaohongshu/app_v2/search_notes'],
  'xiaohongshu.user_search': ['/api/v1/xiaohongshu/app_v2/search_users'],
